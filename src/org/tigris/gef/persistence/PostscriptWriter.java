...
public class PostscriptWriter extends Graphics2D {
	...
	public PostscriptWriter(String filename) throws IOException {
		psWriter = new org.tigris.gef.persistence.export.PostscriptWriter(filename);
	}

	public PostscriptWriter(String filename, Rectangle boundingBox) throws IOException {
		psWriter = new org.tigris.gef.persistence.export.PostscriptWriter(filename, boundingBox);
	}

	public PostscriptWriter(OutputStream stream) throws IOException {
		psWriter = new org.tigris.gef.persistence.export.PostscriptWriter(stream);

	}

	public PostscriptWriter(OutputStream stream, Rectangle bb) throws IOException {
		psWriter = new org.tigris.gef.persistence.export.PostscriptWriter(stream, bb);
	}
	...
	public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
		...
		return psWriter.drawImage(img, dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2, bgcolor, observer);
	}
	...
	public boolean drawImage(java.awt.Image image, java.awt.geom.AffineTransform affineTransform,
			java.awt.image.ImageObserver imageObserver) {
		return psWriter.drawImage(image, affineTransform, imageObserver);
	}

	public void drawImage(java.awt.image.BufferedImage bufferedImage, java.awt.image.BufferedImageOp bufferedImageOp,
			int param, int param3) {
	...
	public void drawString(java.text.AttributedCharacterIterator attributedCharacterIterator, float param,
			float param2) {
